"""Strata process: Hankel matrix two-factor estimator with elbow d-selection."""
...
def main():
    ...
    out_geom = FIG_DIR / "fig1_strata_hankel_geometry.png"
    ...
    out_spec = FIG_DIR / "fig1_strata_hankel_spectrum.png"
