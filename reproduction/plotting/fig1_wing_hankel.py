"""Wing process: Hankel matrix two-factor estimator with elbow d-selection."""
...
def main():
    ...
    out_geom = FIG_DIR / "fig1_wing_hankel_geometry.png"
    ...
    out_spec = FIG_DIR / "fig1_wing_hankel_spectrum.png"
