"""Zero-one-random process: Hankel matrix two-factor estimator with elbow d-selection."""
...
def main():
    ...
    print(f"=== Zero-one-random (TRUE_D={TRUE_D}) ===")
    ...
    out_geom = FIG_DIR / "fig1_zero_one_random_hankel_geometry.png"
    ...
    out_spec = FIG_DIR / "fig1_zero_one_random_hankel_spectrum.png"
