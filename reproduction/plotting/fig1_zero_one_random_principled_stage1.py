"""Zero-One-Random GT | supervised | Stage 1 CCA/RRR (minimal wrapper).

Identical to fig1_zero_one_random_principled.py but uses Stage 1 CCA/RRR subspace.
...
def main():
    ...
    hmm = build_hidden_markov_model("zero_one_random", ZOR_PARAMS)
    ...
    print(f"zero_one_random belief-decode R^2:  supervised(64-D)={r2_sup:.3f}   stage1({D}-D)={r2_s1:.3f}")
    ...
    for a in ax:
        a.axis("off")
    out = FIG_DIR / "fig1_zero_one_random_principled_stage1.png"
