"""D-selection analysis for zero_one_random process.

Tests effective rank + MI saturation d-selection methods on known process.
Compares spectral-OOM vs CCA/RRR.
"""
...
TRUE_D = 3
MODEL_FILE = "zero_one_random_transformer.pt"
