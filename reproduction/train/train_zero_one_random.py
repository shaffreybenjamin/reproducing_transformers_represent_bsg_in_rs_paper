"""Train a transformer on zero_one_random with the QUANTUM-PAPER training setup.
...
def main() -> None:
    ...
    data = build_process_data(PROCESS, ZERO_ONE_RANDOM_PARAMS, CONTEXT_LEN, device)
    ...
    ax.set_title(f"zero_one_random (quantum-paper config) training (final {epoch_losses[-1]:.4f})")
    ax.legend()
