"""Train a transformer on arch with the QUANTUM-PAPER training setup.
...
arch: a=0.85 (vocab 3, 4 hidden states).
"""
...
def main() -> None:
    ...
    data = build_process_data(PROCESS, ARCH_PARAMS, CONTEXT_LEN, device)
    ...
    ax.set_title(f"arch (quantum-paper config) training (final {epoch_losses[-1]:.4f})")
    ax.legend()
