"""Train a transformer on strata with the QUANTUM-PAPER training setup.
...
def main() -> None:
    ...
    data = build_process_data(PROCESS, STRATA_PARAMS, CONTEXT_LEN, device)
    ...
    ax.set_title(f"strata (quantum-paper config) training (final {epoch_losses[-1]:.4f})")
    ax.legend()
