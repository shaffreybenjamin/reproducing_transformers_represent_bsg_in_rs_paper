...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.9\textwidth]{fig28_mess3_principled.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.8\textwidth]{fig06_training_progression_mess3.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.8\textwidth]{fig08_unsupervised_controls_mess3.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.9\textwidth]{fig26_rrxor_principled.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.9\textwidth]{fig34_rrxor_diagnostics_supervised.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.9\textwidth]{fig35_rrxor_diagnostics_unsupervised.png}
...
significant next-token degeneracy, i.e. many geometrically distinct states share similar next-token distributions 
(R$^2$=0.31 from the original paper). It is unclear whether this issue with the spectral-OOM estimator can be fully 
addressed, as there are no obvious alternative observables satisfying the required properties (linearity in belief, 
empirical accessibility). A longer context window could mitigate this by providing more data per horizon depth, 
reducing compounding errors in deep recursion. Success on Mess3 demonstrates the method's viability for processes 
where belief geometry aligns with observable structure. A natural next experiment is a richly-sampled quantum or 
post-quantum process where this alignment should hold more generally.
...
Mess3's true operators are diagonalisable strict contractions; the fractal is their attractor,
and the rollout self-corrects.

\begin{figure}[!ht]
\centering
\includegraphics[width=0.9\textwidth]{fig29_mess3_supervised_rollout.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.9\textwidth]{fig23_mess3_unified.png}
...
Hence for RRXOR the raw subspace (main text), not the rollout, is the trustworthy representation.

\begin{figure}[!ht]
\centering
\includegraphics[width=0.9\textwidth]{fig29_rrxor_supervised_rollout.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.9\textwidth]{fig24_rrxor_unified.png}
